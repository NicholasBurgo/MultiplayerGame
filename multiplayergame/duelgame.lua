...
function duelGame.load()
    ...
    -- Load spritesheets
    duelGame.startSprite = love.graphics.newImage("duelstart.png")
    duelGame.winSprite = love.graphics.newImage("duelwin.png")
    duelGame.loseSprite = love.graphics.newImage("duellose.png")
